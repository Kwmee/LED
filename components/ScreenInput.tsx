    ...
    <section className="border-b border-slate-300">
      ...
      <div className="grid gap-2 px-2 py-2">
        <label className="block text-[12px]">
          <span className="mb-1 block font-medium uppercase tracking-[0.04em] text-slate-600">Width (m)</span>
          <input
            type="number"
            min="0.1"
            step="0.1"
        ...
        <label className="block text-[12px]">
          <span className="mb-1 block font-medium uppercase tracking-[0.04em] text-slate-600">Height (m)</span>
          <input
            type="number"
            min="0.1"
            step="0.1"
        ...
        <label className="block text-[12px]">
          <span className="mb-1 block font-medium uppercase tracking-[0.04em] text-slate-600">Pixel Pitch (mm)</span>
          <input
            type="number"
            min="0.1"
            step="0.1"
